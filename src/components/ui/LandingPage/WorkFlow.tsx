      ...
      <div className="container mx-auto px-4 max-w-screen-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center step">
            <FaSearch className="text-6xl text-blue-500 mb-6 animate-bounce" />
          ...
          <div className="flex flex-col items-center step">
            <FaCalendarCheck className="text-6xl text-blue-500 mb-6 animate-bounce" />
          ...
          <div className="flex flex-col items-center step">
            <FaSmile className="text-6xl text-blue-500 mb-6 animate-bounce" />
